...
\cvHeadingListStart
\cvHeading
{Flutter}{\href{https://flutter.dev/}{flutter.dev}}{Flutter is Google's SDK for crafting beautiful, fast user experiences for mobile, web, and desktop from a single codebase.}
\cvHeading
...
\cvHeading{Drift}{\href{https://drift.simonbinder.eu/}{drift.simonbinder.eu}}{Drift is a reactive persistence library for Flutter and Dart, built on top of SQLite. (Flutter, SQLite)}
