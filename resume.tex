...
\subsection*{
  \begin{tabularx}{0.98\textwidth}[t]{@{}X r}
    Prudential plc & \normalfont{\textit{\footnotesize{\href{https://www.prudentialplc.com/}{prudentialplc.com}}}} \\
  \end{tabularx}
}

\begin{tabular}{r|l}
  \footnotesize{Oct 2024 - Present} & Lead Software Developer                    \\
                                    & \textcolor{gray}{\footnotesize{Singapore}} \\
\end{tabular}

\subsubsection*{PruServices Project}

\textcolor{gray}{\small{PruServices is Prudential's customer-facing application designed to help users manage their insurance policies efficiently. It provides features such as policy tracking, claims submission, premium payments, and personalized recommendations, ensuring a seamless and user-friendly experience.}}

\hspace{1pt}

\small \textbf{Tools and technologies}: {\footnotesize Flutter, Dart, Typescript, GraphQL, NodeJS, NestJS, REST, Socket.io, MixPanel, Firebase, Sentry, Git, Bash}.


\cvItemListStart
\item Designed and implemented the architecture and structure for Flutter projects and packages.
\item Managed and maintained package dependencies and Flutter SDK versions to ensure compatibility and stability.
\item Led a team of 5 developers to deliver high-quality software solutions.
\cvItemListEnd
...
{Flutter}{\href{https://flutter.dev/}{flutter.dev}}{
  I am a member of the Flutter Github organization with \href{https://github.com/flutter/flutter/pull/152361\#pullrequestreview-2201981291}{contributor access} to the repositories with over 150 contributions. My contributions to the flutter framework are mostly around the theme, testing and fixing memory leaks. I was mentioned several times \href{https://github.com/flutter/flutter/issues/121415\#issuecomment-2495120324}{[1]} \href{https://github.com/flutter/flutter/issues/121415\#issuecomment-2465885271}{[2]} in the Flutter notable commits.
  \newline
